            ...
            <tr class="success">
                ...
                <td>
                    ...
                    <s:if test="#ppll.status == 4">审核通过&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="PaperAction_toPrintPaperNiuBi?id=<s:property value="#ppll.id"/>" title="打印"
                           target="_blank">
                            <img alt="打印" src="image/print.jpg">
                        </a>
                        <a href="PaperAction_toPrintPaperAnswers?id=<s:property value="#ppll.id"/>" title="打印答案"
                           target="_blank">
