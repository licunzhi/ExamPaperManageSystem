...
<div class="adminpos"><a href="adminlogin.jsp" class="btn btn-success btn-lg" style="border-radius:20px;">管理员登陆</a>
</div>
<div class="container">
    <br><br>
    <form id="loginform" action="UserAction_doCheckUser" method="post" class="form-horizontal"
