...
<div class="container">
    ...
    <div style="border:2px groove;border-radius:15px;">
        <form action="QuestionsAction_doAddQuestion?pid=<s:property value="#session.pid"/>" method="post"
              class="form-horizontal" id="formdate">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <label class="radio-inline"> <input type="radio" name="qanswer" id="qanswer" value="T">T</label>
                    <label class="radio-inline"> <input type="radio" name="qanswer" id="qanswer" value="F">F</label>
                </div>
            </div>
