            ...
            <s:iterator value="#session['paperllist']" id="pllist" status="ppnum">
                <s:if test="#pllist.user.id == #ulist.id">
                    <tr class="success">
                        ...
                        <td>
                            <a href="PaperAction_toViewPaperIsOk?id=<s:property value="#pllist.id"/>"
                               target="_blank"><img alt="预览" src="image/view.png" title="预览"></a>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="PaperAction_toSetPaperPast?id=<s:property value="#pllist.id"/>"><img alt="通过"
                                                                                                          src="image/success.jpg"
                                                                                                          title="通过"></a>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="PaperAction_toSetPaperNotPast?id=<s:property value="#pllist.id"/>"><img alt="否决"
                                                                                                             src="image/fail.jpg"
                                                                                                             title="否决"></a>
                        </td>
                    </tr>
