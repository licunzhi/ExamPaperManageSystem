...
<div class="container">
    <div>
        <font size="4px" color="green">通过：</font>
        <a href="PaperAction_toSetPaperPast?id=<s:property value="#session.paper.id"/>">
            <img alt="通过" src="image/success.jpg" title="通过"></a>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <font size="4px" color="red">否决：</font>
        <a href="PaperAction_toSetPaperNotPast?id=<s:property value="#session.paper.id"/>">
            <img alt="否决" src="image/fail.jpg" title="否决"></a>
    </div>
            ...
            <div class="row"><!-- 试卷的标题 -->
                ...
                <s:iterator value="#session['questionlist']" id="ql" status="qnum">
                    <s:if test="#ql.page.id == #pl.id">
                        <div class="happystyle"><font size="1px"><s:property value="#qnum.index + 1"/>、<s:property
                                value="#ql.qtitle"/></font></div>
