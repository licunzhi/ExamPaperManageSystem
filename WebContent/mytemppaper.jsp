    ...
    <table class="table table-hover" style="table-layout:fixed">
        ...
        <s:iterator value="#session.paperlisttemp" id="ppll" status="pppnum">
            <tr class="success">
                ...
                <td style="overflow:hidden;white-space:nowrap;text-overflow:ellipsis;"><s:property
                        value="#ppll.title"/></td>
                <td><s:property value="#ppll.date"/></td>
                <td>
                    <a href="PaperAction_toModifyPaperMethod?id=<s:property value="#ppll.id"/>"><font
                            color="red">修改</font></a>
                    <font color="red">||</font>
                    <a href="PaperAction_setPaperDispearStatusAndToTempPage?id=<s:property value="#ppll.id"/>"><font
                            color="red">删除</font></a>
                </td>
            </tr>
        </s:iterator>
