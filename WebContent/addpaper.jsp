	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-2 col-md-offset-4">
				<button class="btn btn-info" style="border-radius:20px;margin-top:20px;" data-toggle="modal" data-target="#myModal">标题增加、修改</button>
			</div>
			<div class="col-md-2">
				<a class="btn btn-info" id="add" style="border-radius:20px;margin-top:20px;"  data-toggle="modal" data-target="#myModal1">增加页面</a>
			</div>
		</div>
		...
		<s:if test="#session['pagelist'] != null">
			<s:iterator value="#session['pagelist']" id="pl" status="num">
				<div class="row">
					...
					<div class="col-md-1 col-md-offset-6 btn btn-info"><a href="QuestionsAction_toAddQuestionPage?qtype=<s:property value='#pl.qtype'/>&pid=<s:property value="#pl.id"/>" style="color:white;">添加问题</a></div>
					<div class="col-md-1 btn btn-danger"><a href="PageAction_doDeletePage?id=<s:property value='#pl.id'/>" style="color:white">删除本页</a></div>
					<!-- 
						恐怕是需要迭代中间增加新的迭代了 
					...
					<s:iterator value="#session['questionlist']" id="ql" status="qnum">
						<s:if test="#ql.page.id == #pl.id">
							<div class="col-md-12 happystyle">
								...
								<a href="QuestionsAction_doDeleteQuestion?id=<s:property value="#ql.id"/>" class="btn btn-danger btn-xs">删除</a>
							</div>
		...
		<s:if test="#session['paper'].title != null">
			<div class="row">
				<div class="col-md-offset-9 col-md-1 btn btn-primary">
					<a href="PaperAction_setPaperTempStatus?id=<s:property value="#session['paper'].id"/>" style="color: white">保存草稿箱</a>
				</div>
				<div class="col-md-1 btn btn-success">
					<a href="PaperAction_setPaperCheckStatus?id=<s:property value="#session['paper'].id"/>" style="color: white">提交审阅</a>
				</div>
				<div class="col-md-1 btn btn-warning">
					<a href="PaperAction_setPaperDispearStatus?id=<s:property value="#session['paper'].id"/>"style="color: white">丢弃试卷</a>
				</div>
			</div>
		</s:if>
	</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-default"  style="border-radius:20px;" data-dismiss="modal">取消</button>
      </div>
    </div>
  </div>
  </form>
      ...
      <fieldset>
        	<div class="form-group">
        		...
        		<input class="form-control" type="number" name="pageid" id="pageid" step="1"
                                   min="0" data-bv-greaterthan-inclusive="false" data-bv-greaterthan-message="页数从1开始最大为10"
