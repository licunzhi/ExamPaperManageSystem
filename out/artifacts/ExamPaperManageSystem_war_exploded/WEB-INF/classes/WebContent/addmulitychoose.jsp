	...
	<div class="container">
		...
		<!-- 问题的显示部分 -->
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
						<label class="checkbox-inline"> <input type="checkbox" name="qanswer" id="qanswer" value="A">A</label> 
						<label class="checkbox-inline"> <input type="checkbox" name="qanswer" id="qanswer" value="B">B</label> 
						<label class="checkbox-inline"> <input type="checkbox" name="qanswer" id="qanswer" value="C">C</label>
						<label class="checkbox-inline"> <input type="checkbox" name="qanswer" id="qanswer" value="D">D</label>
					</div>
			</div>
