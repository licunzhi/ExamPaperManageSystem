        ...
        <div class="row">
            ...
            <section>
                ...
                <div class="col-lg-8 col-lg-offset-2">
                    <form id="defaultForm" method="post" action="UserAction_doJustUpdateUserInfo" class="form-horizontal">
                        <fieldset>
                        <!-- 隐藏属性的提交问题 -->
                        <input type="hidden" name="id" value="${session.uuuser.id }">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-5">
                                    <input type="text" class="form-control" name="name" value="${session.uuuser.name }"/>
                                </div>
                            </div>
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-lg-5">
                                    <input type="password" class="form-control" name="password" value="${session.uuuser.password }"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 control-label">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-lg-5">
                                    <input type="text" class="form-control" id="userid" name="userid" value="${session.uuuser.userid }"/>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="col-lg-9 col-lg-offset-3">
                                <button type="submit" class="btn btn-primary sub"  style="border-radius:20px;">确认修改</button>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <div type="button" class="btn btn-success" style="border-radius:20px;">
                                <a href="AdminAction_toFindAllUser"><font color="white">取消</font></a>
                                </div>
                            </div>
                        </div>
                    </form>
